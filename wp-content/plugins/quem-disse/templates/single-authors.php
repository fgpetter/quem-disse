  ...
  <body <?php body_class(); ?>>
    ...
    <div id="site-content" role="main" style="max-width: 1000px; margin: 0 auto;">
      ...
      <div class="entry-content">
        ...
        <div class="row">
          <div class="col-3">
            <?php $media_url = get_post_meta( get_the_ID(), '_custom_media', true ); 
              if( ! empty( $media_url ) ) : ?>
          ...
          <div class="col-9">
            ...
            <h4 class="author-description"><?php the_title(); ?></h4>
            <h4>+1K &nbsp; Formada &nbsp; +10</h4>
          </div>
        </div>

        <div class="card p-3 border-0 card-credentials mb-4">
          <?php $job = get_post_meta( get_the_ID(), '_author_job', true ); 
            if( ! empty( $job ) ) : ?>
              <p class="author-job">
            ...
            <?php $tempo = get_post_meta( get_the_ID(), '_author_selo_tempo', true ); 
            if( ! empty( $tempo ) ) : ?>
            ...
            <?php $formacao = get_post_meta( get_the_ID(), '_author_job', true ); 
            if( ! empty( $formacao ) ) : ?>
              <p class="author-job mb-0">
                <strong> <?php echo strtoupper($formacao) ?> </strong> 
                <?php $drt = get_post_meta( get_the_ID(), '_author_drt', true );
                  if( ! empty( $drt ) ) : ?>
                    (DRT: <?php echo $drt; ?>)
                  <?php endif ?>
              </p>
            ...
            <?php $editorial = get_post_meta( get_the_ID(), '_author_bio', true ); 
            if( ! empty( $editorial ) ) : ?>
              <p class="author-bio"><?php echo $editorial; ?></p>
            <?php endif ?>

            <?php $editorial = get_post_meta( get_the_ID(), '_author_editorial', true ); 
            if( ! empty( $editorial ) ) : ?>
        ...
        <div class="author-social-media mb-4">
          ...
          <?php $linkedin = get_post_meta( get_the_ID(), '_author_linkedin', true ); 
            ...
            if( ! empty( $instagram ) ) : ?>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16" style="color:#c32070;">
            ...
            <?php $email = get_post_meta( get_the_ID(), '_author_email', true ); 
            if( ! empty( $email ) ) : ?>
              <a href="mailto:<?php echo $email; ?>" class="author-email text-decoration-none ms-5"> Entre em contato: 
        ...
        <div class="auhtor-posts">
          <?php 
            $author = get_post_meta( get_the_ID(), '_author_username', true );
